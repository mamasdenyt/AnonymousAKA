...
<div id="wrap">
	...
	<div id="kiri">
		...
		<ul>
		<li align="center" >Silahkan Berbelanja</a></li> 
		<li> <a href='halaman_awal.php' >Halaman Awal</a></li> 
			<?php
			if (isset($_SESSION['user'])) {
   ...
   <?php
	if (isset($_SESSION['user'])){
	echo "<h2>Welcome  ".$_SESSION['user'];
	}
	else {
		echo "<h2> WELCOME";
	}?></h2>
	<p style="textalign:justihy"><b>Aulia Store</b> merupakan web yang menyediakan berbagai kebutuhan 
	berbelanja sesuai kebutuhan anda seperti <ul>
	<li>Sepatu </li>
	<li>Tas</li>
	<li>dll </li>
	</ul></p>
